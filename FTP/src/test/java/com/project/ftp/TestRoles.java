...
public class TestRoles {
    ...
    public void testRelatedUsers() {
        ...
        Assert.assertEquals("U2,U3,U1", String.join(",", rolesService.getRelatedUsers("U1")));
        Assert.assertEquals("U2,U3,U1", String.join(",", rolesService.getRelatedUsers("U2")));
        Assert.assertEquals("U2,U3,U1", String.join(",", rolesService.getRelatedUsers("U3")));
        Assert.assertEquals("U5,U4", String.join(",", rolesService.getRelatedUsers("U4")));
        Assert.assertEquals("U3,U5,U4", String.join(",", rolesService.getRelatedUsers("U5")));
        ...
        Assert.assertNull(rolesService.getRelatedUsers("U11"));
    }
    @Test
    ...
    public void testRoleService() {
        ...
        Assert.assertEquals(10, rolesService.getAllRoles().size());
